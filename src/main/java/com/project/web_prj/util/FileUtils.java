...
public class FileUtils {
    ...
    public static String uploadFile(MultipartFile file, String uploadPath) {
        ...
        // 중복이 없는 파일명으로 변경하기
        // ex) 상어.png -> 3fsdfdsfsdfsdfsdfsdfsdfsdfsdf_상어.jpg
        String newFileName = UUID.randomUUID().toString() + "_" + file.getOriginalFilename();

        // 업로드 경로를 변경
        // E:/sl_test/upload  -> E:/sl_test/upload/2022/08/01
    ...
    /**
     * 원본 업로드를 받아서 일자별 폴더를 생성 한 후 최종경로를 리턴
     * @param uploadPath - 원본 업로드 경로
     * @return 일자별 폴더가 포함된 새로운 업로드 경로
     */
    private static String getNewUploadPath(String uploadPath) { //폴더만듬
        ...
        return newUploadPath; // 폴더다만들고 파일을넣어줌
    }
