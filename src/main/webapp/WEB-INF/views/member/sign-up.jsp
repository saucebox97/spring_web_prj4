...
<body>
                    ...
                    <div class="card-body">
                        ...
                        <form action="/member/sign-up" name="signup" id="signUpForm" method="post" style="margin-bottom: 0;">
                            ...
                            <table style="cellpadding: 0; cellspacing: 0; margin: 0 auto; width: 100%">
                                ...
                                <tr>
                                    <td><input type="password" minlength="4" id="password" name="password"
                                            class="form-control tooltipstered" maxlength="20" required="required"
                                            aria-required="true"
                                            style="ime-mode: inactive; margin-bottom: 25px; height: 40px; border: 1px solid #d9d9de"
                                            placeholder="영문과 특수문자를 포함한 최소 4-20자"></td>
                                </tr>
                                <tr>
                                    <td style="text-align: left">
                                ...
                                <tr>
                                    <td><input type="password" minlength="4" id="password_check" name="pw_check"
                                            class="form-control tooltipstered" maxlength="20" required="required"
                                            aria-required="true"
                                            style="ime-mode: inactive; margin-bottom: 25px; height: 40px; border: 1px solid #d9d9de"
    ...
    <script>
        ...
        $(document).ready(function () {
            //입력값 검증 정규표현식 // ^로 시작 $로 끝남 *1개이상 .문자 or 숫자 or 공백 1개이상
            ...
            $('#password').on('keyup', function () {
                ...
                //비밀번호 유효성검사
                else if (!getPwCheck.test($("#password").val()) || $("#password").val().length < 4) {
                    $('#password').css('border-color', 'red');
                    $('#pwChk').html('<b class="c-red">[특수문자 포함 4자이상]</b>');
                    checkArr[1] = false;
                } else {
